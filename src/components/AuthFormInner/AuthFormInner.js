    ...
    return (
      <>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control type="text" placeholder="Enter login" value={loginField} onChange={(e)=>useLoginField(e.target.value)} />
        </Form.Group>
  
        <Form.Group className="mb-3" >
          <Form.Label>Password</Form.Label>
          <Form.Control type="password" placeholder="Password" value={passField} onChange={(e)=>usePassField(e.target.value)}/>
        </Form.Group>
      </>
    );
  }
